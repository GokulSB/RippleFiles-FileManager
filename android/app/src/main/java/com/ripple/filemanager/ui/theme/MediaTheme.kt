...
val LightSkylineLedgerColors = SkylineLedgerColors(
    ...
    textPrimary = Color(0xFF2C2C2A), // dark ink for light theme
    hairline = Color(0xFFE0E0E0),
    textFaintPrimary = Color(0xFF6E6C65), // faint dark text
    textFaintSecondary = Color(0xFF8C897E), // secondary dark text
