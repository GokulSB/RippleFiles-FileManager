...
val LightSkylineLedgerColors = SkylineLedgerColors(
    ...
    textPrimary = Color(0xFFFFFFFF), // changed from ink to white for light-mode-dark-theme
    hairline = Color(0xFFE0E0E0),
    textFaintPrimary = Color(0xFFE8E8E8), // brighter faint text
    textFaintSecondary = Color(0xFFD4D4D4), // brighter secondary text
